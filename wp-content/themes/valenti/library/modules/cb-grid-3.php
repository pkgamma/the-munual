...
$cb_size_class = ' cb-s xs';

if ( $i  == 1 ) {
    $cb_feature_width = '750';
    $cb_feature_height = '400';
    $cb_size_class = ' cb-l';
    echo '<div class="cb-grid-block cb-style-overlay ' . $cb_module_style . ' clearfix">' . $cb_title_header . '<div class="cb-grid-3 cb-grid-module clearfix">';
}
?>
