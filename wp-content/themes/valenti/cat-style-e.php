...
<article id="post-<?php the_ID(); ?>" <?php post_class("cb-blog-style-e cb-small cb-blog-style cb-color-hover cb-article-row-2 cb-article-row cb-separated clearfix cb-no-$cb_count" ); ?> role="article">
