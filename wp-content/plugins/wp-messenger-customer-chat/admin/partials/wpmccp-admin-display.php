...
<div class="wrap">
	...
	<p>Facebook recently made available in open beta their <a href="https://developers.facebook.com/docs/messenger-platform/discovery/customer-chat-plugin" target="_blank">Messenger Customer Chat Plugin</a> which allows you to integrate Messenger experience directly into your website. Get yours today!</p>
    ...
    <h2 class="nav-tab-wrapper">
        <a href="?page=wpmccp&tab=required" class="nav-tab <?php echo $active_tab == 'required' ? 'nav-tab-active' : ''; ?>">Required Setup</a>
        <a href="?page=wpmccp&tab=options" class="nav-tab <?php echo $active_tab == 'options' ? 'nav-tab-active' : ''; ?>">Customize</a>
