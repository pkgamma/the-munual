...
class WPMCCP {
	...
	private function define_public_hooks() {
		...
		$is_fb_sdk_enabled = ! isset($plugin_options['is_fb_sdk_enabled']) ? true : $plugin_options['is_fb_sdk_enabled'];
		$is_fb_sdk_at_header = ! isset($plugin_options['is_fb_sdk_at_header']) ? true : $plugin_options['is_fb_sdk_at_header'];

		$this->loader->add_action( 'wp_footer', $plugin_public, 'wpmccp_messenger_chat' );
		if ( $is_fb_sdk_enabled && $is_fb_sdk_at_header ) {
			$this->loader->add_action( 'wp_header', $plugin_public, 'wpmccp_fb_sdk' );
		}
		if ( $is_fb_sdk_enabled && ! $is_fb_sdk_at_header ) {
			$this->loader->add_action( 'wp_footer', $plugin_public, 'wpmccp_fb_sdk' );
		}
